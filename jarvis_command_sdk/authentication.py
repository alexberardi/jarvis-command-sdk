...
class AuthenticationConfig:
    ...
    refresh_interval_seconds: int = 600  # 10 min (refresh when <10 min remaining)
    refresh_token_secret_key: str | None = None  # e.g. "GOOGLE_REFRESH_TOKEN"
    ...
    def to_dict(self) -> dict:
        ...
        if self.native_redirect_uri:
            result["native_redirect_uri"] = self.native_redirect_uri
